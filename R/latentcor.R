...
#' @param use.nearPD Logical indicator. \code{use.nearPD = TRUE} get nearest positive definite matrix with shrinkage adjustment by \code{nu}. Output \code{R} is the same as \code{Rpointwise} if \code{use.nearPD = FALSE}. Default value is TRUE.
