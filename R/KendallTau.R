...
#' @rdname KendallTau
#'
#' @return \code{Kendall(X)} returns a p1 by p1 matrix of Kendall's tau correlation coefficients. \code{Kendall(X, Y)} returns a p1 by p2 matrix of Kendall's tau correlation coefficients.
#'
#' @export
#' @importFrom pcaPP cor.fk
Kendall = function(X, Y = NULL){ # X and Y are matrix.
