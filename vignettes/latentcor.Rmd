...
|zero-inflated (truncated) | @yoon2020sparse | @yoon2020sparse | @yoon2020sparse | This Appendix |
...
By default, `latentcor` uses `ratio = 0.9`, but this value can be modified by the user
