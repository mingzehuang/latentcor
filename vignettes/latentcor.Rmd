...
``` 
  ...
  - `plotR`: NULL by default as `showplot = FALSE` in `estR`. Otherwise displays a heatmap of latent correlation matrix for `mtcars` (See [heatmap for latent correlation for mtcars](https://rpubs.com/mingzehuang/797937)).
