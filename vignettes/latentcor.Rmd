...
The inverse bridge function is an analytic function of at most 5 parameters (see Theorem of bridge functions):
...
```{r estimate3}
estR(X, types = c("con", "bin", "ter", "tru"), method = "approx")
```
