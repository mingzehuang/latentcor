...
Here `estimate` is a list with several elements:
```{r}
names(estimate)
```
...
#### Definition 2 (Binary model) @fan2017high
...
#### Definition 4 (Truncated or zero-inflated model)
